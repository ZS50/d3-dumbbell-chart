...
export class LineChartComponent implements OnInit {
  ...
  private drawLineAndPath() {
    ...
    this.svg.selectAll("dot").data(this.data).enter().append("circle")
      .attr("r", 5)
    ...
    // .attr("x1", (d: any) => { return this.x(d.value); })
    // .attr("y1", 0)
    // .attr("x2", 200)
    // .attr("y2", 0)
    ...
    .join("line")
      .attr("stroke", "green")
      .attr("stroke-width", 2)
      .attr("x1", (d: any) => this.x(d.visits[0]))
      .attr("x2", (d: any) => this.x(d.visits[1]))
      .attr("y1", (d: any) => this.y(76))
      .attr("y2", (d: any) => this.y(76));
  }
}
